    ...
    <footer className="bg-secondary text-secondary-foreground border-t">
      <div className="container mx-auto grid grid-cols-1 gap-12 px-4 py-16 md:grid-cols-4 md:px-6">
        <div className="space-y-4 md:col-span-1">
          ...
          <p className="text-sm">
            Providing quality vocational education for the next generation of professionals.
          </p>
        ...
        <div className="grid grid-cols-2 gap-8 md:col-span-2 md:grid-cols-3">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm">Stay updated with our latest news and events.</p>
